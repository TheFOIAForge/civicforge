          ...
          <div className="p-5">
            ...
            <div className="grid grid-cols-2 gap-2 mb-4">
              ...
              <button
                ...
                style={{ backgroundColor: "#fff", border: "2px solid rgba(0,0,0,0.12)", color: "#111" }}
              >
              ...
              <button
                ...
                className="flex items-center justify-center gap-2 py-2.5 font-mono text-[11px] font-bold cursor-pointer"
                style={{ backgroundColor: "#000", border: "2px solid #000", color: "#fff" }}
              >
              ...
              <button
                ...
                className="flex items-center justify-center gap-2 py-2.5 font-mono text-[11px] font-bold cursor-pointer"
                style={{ backgroundColor: "#1877F2", border: "2px solid #1877F2", color: "#fff" }}
              >
                <svg width="16" height="16" viewBox="0 0 24 24" fill="#fff">
              ...
              <button
                ...
                style={{ backgroundColor: "#5865F2", border: "2px solid #5865F2", color: "#fff" }}
              >
                <svg width="16" height="16" viewBox="0 0 24 24" fill="#fff">
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="font-mono text-[10px] font-bold" style={{ color: "rgba(0,0,0,0.3)" }}>OR USE EMAIL</span>
              <div className="flex-1 h-px" style={{ backgroundColor: "rgba(0,0,0,0.1)" }} />
            </div>
