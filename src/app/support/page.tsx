  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-8">
      ...
      <p className="font-mono text-sm text-gray-mid mb-8 font-bold">
        CIVICFORGE IS FREE AND ALWAYS WILL BE. BUT IF YOU FIND IT USEFUL, YOU CAN HELP KEEP IT RUNNING.
      </p>

      {/* Mission statement */}
      <section className="border-3 border-border bg-surface p-6 md:p-8 mb-8">
        <h2 className="font-headline text-2xl mb-3">Why CivicForge Is Free</h2>
        <p className="font-body text-base text-gray-mid leading-relaxed mb-4">
          Government accountability shouldn&apos;t be behind a paywall. CivicForge uses
        ...
        <p className="font-body text-base text-gray-mid leading-relaxed mb-4">
          ...
          hours building this platform aren&apos;t free. If CivicForge has helped you
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="font-body text-sm text-gray-mid leading-relaxed">
                ...
                CivicForge is to <strong>share it with others</strong>, <strong>use it to contact your reps</strong>,
      ...
      <section className="border-3 border-border bg-surface p-6 mb-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="border-2 border-border p-4 bg-cream-dark">
            <h3 className="font-headline text-lg normal-case mb-1">Share CivicForge</h3>
            <p className="font-body text-sm text-gray-mid leading-relaxed">
          ...
          <div className="border-2 border-border p-4 bg-cream-dark">
            ...
            <p className="font-body text-sm text-gray-mid leading-relaxed">
              CivicForge is open source. Developers can contribute features, fix bugs, or
